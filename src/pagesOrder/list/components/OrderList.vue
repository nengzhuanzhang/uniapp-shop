<template>
  <scroll-view
    ...
    @scrolltolower="getMemeberOrderData"
    scroll-y
    class="orders"
  >
...
const getMemeberOrderData = async () => {
  // 如果数据出于加载中，退出函数
...
const onRefresherrefresh = async () => {
  ...
  await getMemeberOrderData()
  // 关闭动画
  isTriggered.value = true
}

// 订单状态转换
const formatOrderState = (orderState: number) => {
  return orderState && orderStateList[orderState].text
}
